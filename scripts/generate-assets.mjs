...
<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 64 64">
  <defs>
    <linearGradient id="g" x1="0" y1="0" x2="1" y2="1">
      <stop offset="0%" stop-color="${BRAND.indigo600}"/>
      <stop offset="55%" stop-color="${BRAND.indigo500}"/>
...
<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  <defs>
    ...
    <linearGradient id="accent" x1="0" y1="0" x2="1" y2="0">
      ...
      <stop offset="50%" stop-color="${BRAND.indigo500}"/>
      <stop offset="100%" stop-color="${BRAND.violet}"/>
    </linearGradient>
    <radialGradient id="bloomA" cx="50%" cy="50%" r="50%">
      <stop offset="0%" stop-color="${BRAND.indigo500}" stop-opacity="0.55"/>
      <stop offset="100%" stop-color="${BRAND.indigo500}" stop-opacity="0"/>
    </radialGradient>
  ...
  <g transform="translate(88, 92)">
    ...
    <text x="278" y="46" font-family="Verdana, DejaVu Sans, sans-serif" font-size="38" font-weight="700" fill="${BRAND.indigo500}">.</text>
  </g>
